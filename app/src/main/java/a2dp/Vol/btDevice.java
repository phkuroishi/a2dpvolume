...
public class btDevice {
    ...
    /**
     * @param apprestart the apprestart to set
     */
    ...
    /**
     * @param enablegps1 the enablegps to set
     */
    ...
    /**
     * @param enableTTS the enableTTS to set
     */
    ...
    /**
     * @param getLoc This is the flag used to determine if location should be
    ...
    /**
     * @param setV true if we want the stream volume set on connect
     */
    ...
    /**
     * @param sV is an integer 0 = no, 1 = yes This function is used to set the
    ...
    /**
     * @param smsdelay the smsdelay to set
     */
    ...
    /**
     * @param smsstream the smsstream to set
     */
    ...
    /**
     * @param voldelay the voldelay to set
     */
    ...
    /**
     * @param volramp the volramp to set
     */
    ...
    /**
     * @param autovol the autovol to set
     */
     ...
     * @param name is the friendly name typed in by the user to describe this
     *             device
     * @param vol  is the volume to set to when this device is connected This is
     ...
     * @param vol is the default volume when this device is connected This
    ...
    public boolean hasIntent() {
        if (this.pname == null && this.appaction == null)
            return false;
        else
			return true ;
